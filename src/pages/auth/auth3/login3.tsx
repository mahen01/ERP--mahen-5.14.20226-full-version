              ...
              <>
                  ...
                  <Grid container spacing={3}>
                    <Grid sx={{ textAlign: 'center' }} size={12}>
                      <Grid container spacing={1}>
                        <Grid size={12}>
                          <Typography variant="h3">Welcome to the Techromz</Typography>
                        </Grid>
                        <Grid size={12}>
                ...
                <StepWrapper value={activeStep} index={1}>
                  <Grid container spacing={3}>
                    <Grid sx={{ textAlign: 'center' }} size={12}>
                      <Stack sx={{ gap: 1 }}>
                        <Typography variant="h3">Welcome to the Techromz ERP</Typography>
                        <Typography>Sign up or login with your work email.</Typography>
                      </Stack>
                    </Grid>
                    <Grid size={12}>
        ...
        <Grid size={12}>
          <Stack direction="row" sx={{ justifyContent: 'center', alignItems: 'baseline', mb: { xs: -0.5, sm: 0.5 } }}>
            <Typography align="center">
              By signing up, you confirm to have read Techromz's
              <Typography
                component={Link}
                to={'https://techromz.com/privacy-policy-2/'}
                target="_blank"
              ...
              <Typography
                component={Link}
                to={'https://techromz.com/terms-of-use/'}
                target="_blank"
